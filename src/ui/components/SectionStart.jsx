            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-1 text-center lg:text-left">
                    ...
                    <h2 className="text-2xl md:text-3xl text-slate-600 dark:text-slate-300 mb-8 font-medium">
                        Desenvolvedor <span className="text-emerald-500 dark:text-emerald-400">{typedText}</span>
                        <span className="inline-block w-[3px] h-[1em] bg-emerald-500 dark:bg-emerald-400 ml-1 align-middle animate-[blink_1s_step-end_infinite]"></span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-900 dark:text-white font-bold rounded-xl border border-slate-200 dark:border-white/10 transition-all duration-300 backdrop-blur-sm"
                        >
                            Ver projetos
                        </button>
                    </div>
