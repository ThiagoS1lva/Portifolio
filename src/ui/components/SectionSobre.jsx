            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="glass-card p-8 md:p-12 space-y-8">
                    ...
                    <div className="py-6 border-y border-slate-200 dark:border-white/5 flex flex-col items-center">
                        <span className="text-2xl md:text-3xl font-serif italic text-emerald-500 dark:text-emerald-400 text-center">
                            {`"O importante não é como você começa, mas como termina."`}
                        </span>
                    </div>

                    <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed font-light">
                        Clareza, modernidade e qualidade são os pilares que guiam meu fluxo de trabalho. Meu objetivo final é entregar aplicações de <span className="text-sky-500 dark:text-sky-400 font-medium">alto padrão</span>, que resolvam problemas reais com elegância e eficiência.
                    </p>
                </div>
            </div>
        </section>
